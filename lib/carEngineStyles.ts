...
export const CAR_ENGINE_STYLES: Record<CarEngineStyleId, CarEngineStyle> = {
  city: {
    ...
    handlingTargets: {
      ...
      telemetry: {
        ...
        brakingDistancePixels: [175, 238],
        coastRetentionRatio: [0.88, 0.97],
        ...
        reverseLaunchRatio: [0.32, 0.4],
        reverseFifteenPercentSeconds: [0.54, 0.68],
        steeringResponseSeconds: [0.2, 0.28],
  ...
  rally: {
    ...
    handlingTargets: {
      ...
      minimumForwardLaunchRatio: 0.27,
      ...
      telemetry: {
        ...
        brakingDistancePixels: [230, 305],
        coastRetentionRatio: [0.9, 0.97],
        directionEngagementSeconds: [0.03, 0.11],
        forwardTenPercentSeconds: [0.16, 0.6],
        forwardThirtyFivePercentSeconds: [0.75, 1.25],
        forwardSeventyPercentSeconds: [1.8, 6],
        maximumWheelLoadConservationErrorNewtons: [0, 0.5],
        reverseLaunchRatio: [0.33, 0.44],
        reverseFifteenPercentSeconds: [0.56, 0.72],
        steeringResponseSeconds: [0.18, 0.26],
  ...
  taxi: {
    ...
    handlingTargets: {
      ...
      telemetry: {
        ...
        steeringResponseSeconds: [0.24, 0.33],
